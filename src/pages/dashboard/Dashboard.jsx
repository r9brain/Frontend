     ...
     <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
              ...
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">Tendencia de libros este mes</span>
                </div>
              </div>
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">Compras totales</span>
                </div>
              </div>
            </section>
            <section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
              <div className="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
                <div className="px-6 py-5 font-semibold border-b border-gray-100">El numero de ordenes por mes</div>
              ...
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">Ordenes salientes</span>
                </div>
              </div>
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">Visitas del sitio web (utlimo dia)</span>
                </div>
              </div>
              <div className="row-span-3 bg-white shadow rounded-lg">
                <div className="flex items-center justify-between px-6 py-5 font-semibold border-b border-gray-100">
                  <span>Usuarios por orden promedio</span>
              ...
              <div className="flex flex-col row-span-3 bg-white shadow rounded-lg">
                <div className="px-6 py-5 font-semibold border-b border-gray-100">Alumnos por tipo de estudio</div>
                <div className="p-4 flex-grow">
